...
import EstudianteConsulEspeView from "@/views/EstudianteConsulEspeView.vue";
...
const routes = [
  ...
  {
    path: "/estudianteConsulEspe", // los ":" determina el PathVariable
    name: "estudianteConsulEspeView",
    component: EstudianteConsulEspeView,
  },
